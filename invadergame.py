...
while running:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if count >= 5 and milliseconds_delay == 3000:
                ...
                enemyGenerate(500, -7)
            elif count >= 250 and milliseconds_delay == 300:
                enemyGenerate(300, -8)
    ...
    for e in enemy_list:
        if e.gameOverCheck():
            ...
            text_board('NotoSansJP-Regular.ttf', f'倒した敵の数：{count}', WHITE, 50, WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 - 50)
            text_board('NotoSansJP-Regular.ttf', f'再プレイ：sキーを押す', WHITE, 40, WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 + 30)
