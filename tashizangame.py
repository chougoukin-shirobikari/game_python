...
text_board('NotoSansJP-Regular.ttf', 50, '足し算ゲーム', WHITE, WINDOW_HEIGHT // 2, 50)
...
class Game():
    ...
    def add(self):
        text_board('NotoSansJP-Regular.ttf', 100, f'{self.a} + {self.b}', WHITE, WINDOW_HEIGHT // 2, WINDOW_HEIGHT // 2 - 110)
