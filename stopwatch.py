...
class StopWatch():
    ...
    def drawLines(self, color):
        pygame.draw.rect(display_surface, BLACK, (0, WINDOW_WIDTH - 178, WINDOW_WIDTH, 6))
    ...
    def stopWatchUpdate(self):
        ...
        self.seconds1, self.seconds0_rect = self.text_board('NotoSansJP-Regular.ttf', 95, seconds1, WHITE)
        self.minutes0, self.seconds0_rect = self.text_board('NotoSansJP-Regular.ttf', 95, minutes0, WHITE)
        self.minutes1, self.seconds0_rect = self.text_board('NotoSansJP-Regular.ttf', 95, minutes1, WHITE)
    ...
    def stopWatchFill(self):
        ...
        pygame.draw.rect(display_surface, BLACK, (160, WINDOW_HEIGHT - 175 - self.minutes0_rect.height, 80, 120))
